        ...
        return (
          <>
            <Tooltip
              title={
                color === '#54D62C'
                  ? `${translate('Visitor.GreenTooltip')}`
                  : color === '#FFC107'
                  ? `${translate('Visitor.YellowTooltip')}`
                  : `${translate('Visitor.RedTooltip')}`
              }
              key={color}
              placement="top"
            >
              <FormControlLabel
                label={
                  color === '#54D62C'
                    ? `${translate('Visitor.Green')}`
                    : color === '#FFC107'
                    ? `${translate('Visitor.Yellow')}`
                    : `${translate('Visitor.Red')}`
                }
                control={
                  <Radio
                    key={color}
