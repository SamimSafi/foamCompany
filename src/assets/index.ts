...
export { default as SpeakerIllustration } from './illustration_Speaker';
...
export { default as RejectIllustration } from './illustration_reject';
export { default as VisitorIllustration } from './illustration_visitor';
